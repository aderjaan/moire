...
func TestSNSNotice(t *testing.T) {
	jsonStr := `
	{
		...
		"UnsubscribeURL" : "https://sns.eu-west-1.amazonaws.com/?Action=Unsubscribe&SubscriptionArn=arn:aws:sns:eu-west-1:646538960088:gallery-upload:965a4d72-6e80-416d-a6e9-f85a91bae746"
	}
	`
